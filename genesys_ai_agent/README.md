# AIM
### building an AI agent add on to the existing genesys control system where the input manual entry for filling the form is replaced by the agent which works on voice commands 
## Architecture 
```
Microphone
      │
